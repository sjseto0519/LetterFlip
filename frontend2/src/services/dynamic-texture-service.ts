...
import { IDynamicTextureService } from '../interfaces/services';
import { TextureConfig } from '../interfaces/dynamic-texture';

export class DynamicTextureService implements IDynamicTextureService {
    ...
    public toWallMaterial(config: TextureConfig): StandardMaterial | undefined {
